...
> Примечание: базовая реализация метода **RISE** и реализация метрик были заимствована из открытого репозитория [оригинальной реализации](https://github.com/eclique/RISE/tree/master).  
